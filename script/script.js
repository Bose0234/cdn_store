...
window.onscroll = function () {
  ...
  function stickyHeader() {
    if (window.pageYOffset > sticky) {
      ...
      headerbtn.classList.remove("btn-outline-secondary-pack");
      headerbtn.classList.add("btn-outline-success-pack");
    } else {
      header.classList.remove("sticky-header");
      headerbtn.classList.add("btn-outline-dark-pack");
      headerbtn.classList.remove("btn-outline-success-pack");
    }
  }
